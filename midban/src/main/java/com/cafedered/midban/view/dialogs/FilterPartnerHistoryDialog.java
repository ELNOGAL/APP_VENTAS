...
public class FilterPartnerHistoryDialog extends Dialog {
    ...
    private static FilterPartnerHistoryDialog instance = null;

    public static FilterPartnerHistoryDialog getInstance(Context context,
            final BaseSupportFragment fragment, ListView list, boolean first,
            Partner partner) {
        if (first)
            instance = null;
        if (instance == null)
            instance = new FilterPartnerHistoryDialog(context, fragment, list);
        instance.partner = partner;
        return instance;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public FilterPartnerHistoryDialog(Context context, final BaseSupportFragment fragment,
            final ListView list) {
        super(context);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        this.setContentView(R.layout.dialog_partner_history_filters);

        final EditText dateFromEt = (EditText) findViewById(R.id.dialog_partner_history_from);
        ...
        final EditText dateToEt = (EditText) findViewById(R.id.dialog_partner_history_to);
        ...
        final EditText amountLessThanEt = (EditText) findViewById(R.id.dialog_partner_history_amount_less_than);
        final EditText amountMoreThanEt = (EditText) findViewById(R.id.dialog_partner_history_amount_more_than);
        final Spinner states = (Spinner) findViewById(R.id.dialog_partner_history_filters_spinner_state);
        ...
        Button apply = (Button) findViewById(R.id.dialog_partner_history_filters_button_apply);
        ...
        TextView clearFilters = (TextView) findViewById(R.id.dialog_partner_history_filters_clear);
        clearFilters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dateToEt.setText(v.getResources().getString(
                        R.string.dialog_partner_history_date_to));
                dateFromEt.setText(v.getResources().getString(
                        R.string.dialog_partner_history_date_from));
                amountMoreThanEt.setText(v.getResources().getString(
                        R.string.dialog_partner_history_amount_more_than));
                amountLessThanEt.setText(v.getResources().getString(
                        R.string.dialog_partner_history_amount_less_than));
            }
        });
    }
