...
public class PartnerProductRepository extends BaseRepository<PartnerProduct, PartnerProductDAO> {
    private static PartnerProductRepository instance = null;

    public static PartnerProductRepository getInstance() {
        if (instance == null)
            instance = new PartnerProductRepository();
        return instance;
    }

    private PartnerProductRepository() {
        dao = PartnerProductDAO.getInstance();
    }
}
